...
const App = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://localhost/daftar-pengguna/${newId}/status/penyerahan/tgl/${newTgl}`);
    ...
    <>
      ...
      <Result
        ...
        title={<div>
          ...
          <h2>Barang telah diserahkan</h2> 
          Kepada {data && data.nama} 
        ...
        subTitle={
          <div>
           {/* {data && data.riwayat_asset[0].daftar_asset[0].nama_barang} */}
            <p>Tanda bukti penyerahan dapat dilihat kembali pada riwayat asset</p>
          </div>
        }
        extra={[
